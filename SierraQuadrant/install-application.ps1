...
# Application details
$appFilePath = "bin\Debug\SierraQuadrant.mfappx"
$appGuid = "b4468d38-4bd8-4457-af65-345b7b5c0dd1"

# Target vault
$vaultName = "ARHIVA [SIERRA QUADRANT]"

# Connection details 
$authType = 3 #[MFilesAPI.MFAuthType]::MFAuthTypeLoggedOnWindowsUser
$userName = "super"
$password = "1234"
$domain = ""
$spn = ""
